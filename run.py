...
#Place the ships randomly inide our board
 ...
 # Ask for input and verifies if input is valid, will run until a valid input
...
# Runs a loop through the table and when finds an "X" fills the hit_ship variable.
